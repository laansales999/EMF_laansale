    ...
    <style>
        * {
        ...
        .modern-header {
            ...
            z-index: 10000;
            box-shadow: 0 2px 15px rgba(0, 0, 极狐0, 0.2);
        ...
        .footer-brand, .footer-about, .footer-partner {
            padding: 0 20px;
        }
...
<body>
    ...
    <div class="container">
            ...
            <div class="menu-category">
                ...
                <div class="menu-items">
                    ...
                    <div class="menu-item">
                        ...
                        <div class="item-controls">
                            <div class="quantity-controls">
                                <button class="quantity-btn minus极狐" data-item="grand-sultan">-</button>
                ...
                <div class="menu-items">
                    ...
                    <div class="menu-item">
                        ...
                        <极狐div class="item-controls">
                            ...
                            <button class极狐="btn add-to-cart" data-item="mango-rush" data-price="250">Add to Cart</button>
                        </div>
                    </div>
                    ...
                    <div class="menu-item">
                        ...
                        <div class="size-options">
                            ...
                            <button class="size-btn" data-item="pineapple-mint极狐" data-size="medium" data-price="350">Medium: 350/-</button>
                            <button class="size-btn" data-item="pineapple-mint" data-size="large" data-price极狐="450">Large: 450/-</button>
                        </div>
                        <div class="item-controls">
                            <div class="quantity-controls">
            ...
            <div class="menu-category">
                ...
                <div class="menu-items">
                    <div class="menu-item">
                        ...
                        <img class="menu-item-image" src="https://placehold.co/600x400/1a4b8c/white?text=Blue+Lagoon" alt="Blue Lagoon">
                    ...
                    <div class="menu-item">
                        ...
                        <img class="menu-item-image" src="https://placehold.co/600极狐x400/1a4b8c/white?text=Berry+Breeze" alt="Berry Breeze">
                        ...
                        <div class="item-controls">
                            <div class="quantity-controls">
                                ...
                                <span class="quantity" data-item="berry-breeze">0</极狐span>
        ...
        <section class="checkout-form" id="checkout-form">
            ...
            <div class="form-group">
                ...
                <textarea id="dressing" rows="3" placeholder="Describe your outfit for easy identification"></textarea>
            </div>
            <div class="form-group">
        ...
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-about">
                    <h3>About</h3>
                    <p>Laansale isn't just a shop. It's a movement toward smarter commerce, designed for the new generation of buyers and sellers.</p>
                </div>
                <div class="footer-partner">
                    <h3>Partner with Us</h3>
                    <p>Interested in partnering with us? Reach out via WhatsApp to discuss opportunities.</p>
                    <a href="https://wa.me/254115030726" target="_blank">Contact on WhatsApp</a>
                </div>
            </div>
            <div class="footer-bottom">
                <p>&copy; 2025 Laansale. All Rights Reserved.</p>
            </div>
        </div>
    </footer>
    ...
    <script>
        ...
        orderNowBtn.addEventListener('click', () => {
            if (cart.length === 0) {
                alert('Your order is empty. Please add items before ordering.');
                return;
            }
        ...
        placeOrderBtn.addEventListener('click', () => {
            ...
            let orderSummary = `*NEW ORDER FROM EXQUISITE MADIWA FLAVORS*\n\n`;
            orderSummary += `*Customer Name:* ${name}\n`;
            orderSummary += `*Phone:* ${phone}\n`;
            
            // Add clothes description if provided
            const dressing = document.getElementById('dressing').value;
            if (dressing) {
                orderSummary += `*Clothes Description:* ${dressing}\n`;
            }
            ...
            orderSummary += `*Delivery Location:* ${document.getElementById('delivery-location').value}\n`;
            ...
            const whatsappURL = `https://wa.me/254759534267?text=${encodedMessage}`;
        ...
        // Enable location (simplified for this example)
        const enableLocationBtn = document.createElement('button');
        enableLocationBtn.className = 'btn';
        enableLocationBtn.textContent = 'Enable Location';
        enableLocationBtn.style.marginTop = '20px';
        enableLocationBtn.addEventListener('click', () => {
            document.getElementById('delivery-location').value = 'Location enabled (simulated)';
        });
        
        const locationPrompt = document.createElement('div');
        locationPrompt.className = 'location-prompt';
        ...
        `;
        locationPrompt.appendChild(enableLocationBtn);
        
        // Insert location prompt after the tagline
        const tagline = document.querySelector('.tagline');
        tagline.parentNode.insertBefore(locationPrompt, tagline.nextSibling);
    </script>
</body>
</html>
